...
public class CaptureImage
{
    ...
    public CaptureImage(Texture2D f)
    {
    ...
    public CaptureImage(CaptureImage image)
    {
    ...
    public void DrawImage(CaptureImage image, int i, int i2)
    {
    ...
    public unsafe WebPData GetWebPData()
    {
